...
#config file
class CFG:
    def __init__(self, dataset, model_type, name_postfix, feature_type, pose_method, mode, time, model_weights, cuda_id):
        rand_seed = 1001
        ...
        self.train_transform = Compose([MediapipeDataProcess(),
        ...
        self.test_transform = self.val_transform = Compose([MediapipeDataProcess(),
                                                            ...
                                                            HandCorrection(self.left_slice, self.right_slice),
                                                            NormalizeKeypoints(self.origin_idx, self.anchor_points),
                                                            # TemporalAugmentation(self.frame_augmentation, self.uniform_sample, False),
